...
class DiyarScreen extends StatefulWidget {
  @override
  State<DiyarScreen> createState() => _DiyarScreenState();
}

class _DiyarScreenState extends State<DiyarScreen> {
  String url = "";
  int? number;
  ...
  uploadDataToFirebase() async {
    ...
    await FirebaseFirestore.instance.collection("diyar").doc().set({
      'fileUrl': url,
