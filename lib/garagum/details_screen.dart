...
class GaragumScreen extends StatefulWidget {
  @override
  State<GaragumScreen> createState() => _GaragumScreenState();
}

class _GaragumScreenState extends State<GaragumScreen> {
  String url = "";
  int? number;
  ...
  uploadDataToFirebase() async {
    ...
    await FirebaseFirestore.instance.collection("garagum").doc().set({
      'fileUrl': url,
                                    ...
                                    children: <Widget>[
                                      RichText(
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text: 'Neşir ${i+1} Garagum žurnaly',
                                              style: TextStyle(
                                                fontSize: 16,
                                                color: kBlackColor,
