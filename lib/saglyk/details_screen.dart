...
class SaglykScreen extends StatefulWidget {
  @override
  State<SaglykScreen> createState() => _SaglykScreenState();
}

class _SaglykScreenState extends State<SaglykScreen> {
  String url = "";
  int? number;
  ...
  uploadDataToFirebase() async {
    ...
    await FirebaseFirestore.instance.collection("saglyk").doc().set({
      'fileUrl': url,
