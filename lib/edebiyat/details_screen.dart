...
class EdebiyatScreen extends StatefulWidget {
  @override
  State<EdebiyatScreen> createState() => _EdebiyatScreenState();
}

class _EdebiyatScreenState extends State<EdebiyatScreen> {
  String url = "";
  int? number;
  ...
  uploadDataToFirebase() async {
    ...
    await FirebaseFirestore.instance.collection("edebiyat").doc().set({
      'fileUrl': url,
                                    ...
                                    children: <Widget>[
                                      RichText(
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text: 'Neşir ${i+1} Dünýä edebiýat žurnaly',
                                              style: TextStyle(
                                                fontSize: 16,
                                                color: kBlackColor,
